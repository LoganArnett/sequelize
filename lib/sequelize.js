...
class Sequelize {
   ...
   * If you want to refer to columns in your function, you should use `sequelize.col`, so that the columns are properly interpreted as columns and not as strings.
   *
   * Convert a user's username to uppercase
   * ```js
   ...
   * To enable CLS, add it to your project, create a namespace and set it on the sequelize constructor:
   *
   * ```js
